...
class Report extends Component {
    ...
    updateReport = () => {
        if (this.props.category == 'recreation') {
            axios.get('http://127.0.0.1:8000/report/api/?recreationID=' + this.props.recreationID)
                .then(res => {
    ...
    cancelReport = () => {
        if (this.props.category == 'recreation') {
            axios.delete('http://127.0.0.1:8000/report/api/' + this.props.userid + '/?recreationID=' + this.props.recreationID)
                .then(res => console.log(res)).catch(error => console.error(error));
        }
        else {
